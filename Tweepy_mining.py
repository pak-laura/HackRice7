...
microsoft_words = ['Microsoft', 'microsoft', 'windows', 'powerpoint']
samsung = ['android', 'galaxy tab', 'samsung']

#Create stream listeners and filters
AppleListener = MyStreamListener(filename = 'Apple.csv', time_limit = 4)
